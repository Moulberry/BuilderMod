    ...
    private BlueprintCreateMenu(ProtoBlueprint protoBlueprint) {
        ...
        { // Buttons box
            ...
            buttonsBox.add(new WButton(Text.of("Create")) {
                ...
                if (author == null || author.isEmpty()) author = defaultAuthor;
                ...
                blueprint.save(BuilderMod.getInstance().getBlueprintsFolder());

                BlueprintLibrary.blueprints.put(blueprint.identifier, blueprint);
                MinecraftClient.getInstance().setScreen(null);
            }), 144, 20);
        }
